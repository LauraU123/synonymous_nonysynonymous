...
if __name__=="__main__":
    ...
    with open(args.aa) as f:
        ...
        df1['synonymous mutation/gene'] = df1['synonymous mutations']*3/df1['length of gene'] #per codon
        df1['nonsynonymous mutation/gene']=df1['nonsynonymous mutations']*3/df1['length of gene'] #per codon

    plt.figure(figsize=(8,6))
    gene_names = df1['gene'].to_list()
    gene_name = df1['gene']
    colors_ = np.array(["palegreen","violet","yellow","pink","lightskyblue","orange","gray","cyan","bisque"])
